...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    // Uncomment to allow stat boosts from Hoenn badges
    // if (ShouldGetStatBadgeBoost(FLAG_HOENN_BADGE01_GET, battlerIdAtk))
    //     attack = (110 * attack) / 100;
    // if (ShouldGetStatBadgeBoost(FLAG_HOENN_BADGE03_GET, battlerIdDef))
    //     defense = (110 * defense) / 100;
    // if (ShouldGetStatBadgeBoost(FLAG_HOENN_BADGE05_GET, battlerIdAtk))
    //     spAttack = (110 * spAttack) / 100;
    // if (ShouldGetStatBadgeBoost(FLAG_HOENN_BADGE05_GET, battlerIdDef))
