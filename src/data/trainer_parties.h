...
static const struct TrainerMonItemCustomMoves sParty_Randall[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EXTREME_SPEED, MOVE_AGILITY, MOVE_AERIAL_ACE, MOVE_FLY}
    },
    {
    .iv = 255,
    .lvl = 40,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_FURY_SWIPES, MOVE_FAINT_ATTACK, MOVE_SLASH}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_TAKE_DOWN, MOVE_THRASH, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Parker[] = {
    ...
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWAGGER, MOVE_DIZZY_PUNCH, MOVE_SUPERSONIC, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TEETER_DANCE, MOVE_CONFUSE_RAY, MOVE_WATER_PULSE, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONFUSION, MOVE_DYNAMIC_PUNCH, MOVE_FLATTER, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SOFT_BOILED, MOVE_DOUBLE_EDGE, MOVE_DEFENSE_CURL, MOVE_SING}
    },
    {
    .iv = 255,
    .lvl = 40,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_REST, MOVE_BODY_SLAM, MOVE_DOUBLE_EDGE, MOVE_WISH}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SLACK_OFF, MOVE_AMNESIA, MOVE_FLAIL, MOVE_STRENGTH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = {
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPER_BEAM, MOVE_SLACK_OFF, MOVE_DOUBLE_EDGE, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_ENERGY, MOVE_SLASH, MOVE_SKULL_BASH, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_ENERGY, MOVE_THRASH, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_ENERGY, MOVE_FOCUS_PUNCH, MOVE_EXPLOSION, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Mary[] = {
    ...
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AERIAL_ACE, MOVE_WHIRLWIND, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_SPINDA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_SWIFT, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 39,
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DEFENSE_CURL, MOVE_SLACK_OFF, MOVE_SHADOW_BALL, MOVE_STRENGTH}
    },
    {
    .iv = 255,
    .lvl = 39,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DEFENSE_CURL, MOVE_HEAL_BELL, MOVE_ROLLOUT, MOVE_MILK_DRINK}
    },
    {
    .iv = 255,
    .lvl = 40,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DEFENSE_CURL, MOVE_TAKE_DOWN, MOVE_THRASH, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_MILTANK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DEFENSE_CURL, MOVE_HEAL_BELL, MOVE_BODY_SLAM, MOVE_MILK_DRINK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_STRENGTH, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_THRASH, MOVE_STRENGTH, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_URSARING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_STRENGTH, MOVE_THRASH}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_DODRIO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_DRILL_PECK, MOVE_STRENGTH, MOVE_TRI_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 42,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_HYPER_BEAM, MOVE_STRENGTH, MOVE_BODY_SLAM}
    }
};
...
static const struct TrainerMonItemDefaultMoves sParty_Daphne[] = {
    {
    .iv = 250,
    .lvl = 68,
...
static const struct TrainerMonItemDefaultMoves sParty_Roxanne1[] = {
    {
    .iv = 100,
    .lvl = 22,
    .species = SPECIES_SANDSLASH,
...
static const struct TrainerMonItemDefaultMoves sParty_Winona1[] = {
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_PROTECT, MOVE_MORNING_SUN, MOVE_CALM_MIND}
    },
    {
    .iv = 255,
    .lvl = 66,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_PSYCHIC, MOVE_HYPNOSIS, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 66,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_GLALIE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ICE_BALL, MOVE_PROTECT, MOVE_ICE_BEAM, MOVE_HAIL}
    },
    {
    .iv = 255,
    .lvl = 73,
    .species = SPECIES_JYNX,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ICE_PUNCH, MOVE_PERISH_SONG, MOVE_AMNESIA, MOVE_BLIZZARD}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .moves = {MOVE_ICE_BALL, MOVE_PROTECT, MOVE_ICE_BEAM, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 76,
    .species = SPECIES_PILOSWINE,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ICICLE_SPEAR, MOVE_MIST, MOVE_PROTECT, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 77,
    ...
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_BLIZZARD, MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_SHEER_COLD}
    },
    {
    .iv = 255,
    .lvl = 77,
    .species = SPECIES_WALREIN,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_ICE_BALL, MOVE_BLIZZARD, MOVE_ICE_BEAM, MOVE_SHEER_COLD}
    }
};
...
static const struct TrainerMonItemDefaultMoves sParty_Annika[] = {
    {
    .iv = 250,
    .lvl = 68,
    .species = SPECIES_DEWGONG,
...
static const struct TrainerMonNoItemDefaultMoves sParty_BrendanRoute103[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_MayRoute103[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMonItemDefaultMoves sParty_Gerald[] = {
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_MAGMAR
...
static const struct TrainerMonItemDefaultMoves sParty_Danielle[] = {
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_PONYTA
...
static const struct TrainerMonItemDefaultMoves sParty_Roxanne2[] = {
    {
    .iv = 255,
    .lvl = 32,
    .species = SPECIES_SANDSLASH,
...
static const struct TrainerMonItemDefaultMoves sParty_Roxanne3[] = {
    {
    .iv = 255,
    .lvl = 38,
...
static const struct TrainerMonItemDefaultMoves sParty_Roxanne4[] = {
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_QUAGSIRE,
...
static const struct TrainerMonItemDefaultMoves sParty_Roxanne5[] = {
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_QUAGSIRE,
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BLIZZARD, MOVE_SLACK_OFF, MOVE_FOCUS_PUNCH, MOVE_FIRE_BLAST}
    },
    {
    .iv = 255,
    .lvl = 49,
...
static const struct TrainerMonItemDefaultMoves sParty_Winona2[] = {
    {
    .iv = 255,
    .lvl = 59,
    .species = SPECIES_SCYTHER,
...
static const struct TrainerMonItemDefaultMoves sParty_Winona3[] = {
    {
    .iv = 255,
    .lvl = 67,
    .species = SPECIES_SALAMENCE,
...
static const struct TrainerMonItemDefaultMoves sParty_Winona4[] = {
    {
    .iv = 255,
    .lvl = 70,
    .species = SPECIES_SALAMENCE,
...
static const struct TrainerMonItemDefaultMoves sParty_Winona5[] = {
    {
    .iv = 255,
    .lvl = 75,
    .species = SPECIES_GYARADOS,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza3[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_PSYCH_UP, MOVE_BLIZZARD, MOVE_REST}
    },
    {
    .iv = 255,
    .lvl = 78,
...
static const struct TrainerMonItemCustomMoves sParty_Juan3[] = {
    ...
    .species = SPECIES_DEWGONG,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SAFEGUARD, MOVE_AURORA_BEAM, MOVE_BLIZZARD, MOVE_HAIL}
    },
    {
    .iv = 255,
    .lvl = 84,
    .species = SPECIES_DELIBIRD,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_FOCUS_PUNCH, MOVE_PROTECT, MOVE_HAIL, MOVE_ICE_BALL}
    },
    {
    .iv = 255,
    .lvl = 83,
...
static const struct TrainerMonItemCustomMoves sParty_Juan5[] = {
    ...
    .species = SPECIES_CLOYSTER,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SURF, MOVE_BLIZZARD, MOVE_ICE_BEAM, MOVE_HYPER_BEAM}
    },
    {
    .iv = 255,
    .lvl = 91,
